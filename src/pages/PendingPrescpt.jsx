...
//     (state) => state.user
//   );
//   console.log(medicineSearchResults, "FHASDFJASHFSDFJSFJSFJFJ");

//   useEffect(() => {
//     dispatch(medicineSearch());
//   }, []);
...
//     // New validation: Check if medicine_name is empty
...
//     // New validation: Check for duplicate medicine
//     if (
//       data.treatments &&
...
//       ? selectedMedicine.medicine_id
//       : data.treatments && data.treatments.length > 0
//       ? Math.max(...data.treatments.map((t) => t.medicine_id)) + 1 // Ensure this generates a unique ID if it's a truly "new" medicine not in suggestions
//       : 1000; // Start new dynamic IDs from a high number or use UUID library
