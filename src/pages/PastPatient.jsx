    ...
    const getPatientSuggestions = () => {
      ...
      if (pastPatients) {
        pastPatients.forEach(patient => {
          if (patient.patient_name && !seenNames.has(patient.patient_name.toLowerCase())) {
        ...
        {loading ? (
          ...
          <div className="doc-panel-body pp-list-pg">
            ...
            <div className="past-patients-list-wrp">
              <div className="row">
                {patients.length == 0 ? (
                  <h3 style={{ textAlign: 'center', padding: "25px 0", fontWeight: 'bold', color:"#356598" }}>No data found</h3>
