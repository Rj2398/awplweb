...
//             <Route path="/patient-full-details" element={<PatientFullDetails />} />
//             <Route path="/referred-patient-full-details" element={<ReferredPatientFullDetails />} />
//             <Route path="/patient-profile" element={<PatientProfile />} />
//             <Route path="/patient-profile-full-details" element={<PatientProfileFullDetails />} />
//             <Route path="/referred-patient-profile" element={<ReferredPatientProfile />} />
//             <Route path="/my-appointments" element={<MyAppointments />} />
//             <Route path="/schedule-appointment" element={<ScheduleAppointment />} />
//             <Route path="/completed-appointment-screen" element={<CompletedAppointmentScreen />} />
//             <Route path="/completed-appointments-profile" element={<CompletedAppoinmentsProfile />} />
//             {/* //Pages */}
...
//             <Route path="/pendingprescription" element={<PendingPrescription />} />
//             <Route path="/PendingAssignedPrescriptionDetails" element={<PendingAssignedPrescriptionDetails />} />
//             <Route path="/CompletedAssignedPrescription" element={<CompletedAssignedPrescription />} />
//             <Route path="/pendingfull" element={<PendingFullAssigned />} />
//             <Route path="/UserProfile" element={<UserProfile />} />
//             <Route path="/pastpatient" element={<PastPatient />} />
    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route path="/patient-details" element={<PrivateRoute><Layout><PatientDetails /></Layout></PrivateRoute>} />
                ...
                <Route path="/patient-profile" element={<PrivateRoute><Layout><PatientProfile /></Layout></PrivateRoute>} />
                ...
                <Route path="/schedule-appointment" element={<PrivateRoute><Layout><ScheduleAppointment /></Layout></PrivateRoute>} />
                <Route path="/completed-appointment-screen" element={<PrivateRoute><Layout><CompletedAppointmentScreen /></Layout></PrivateRoute>} />
                ...
                <Route path="/pendingprescription" element={<PrivateRoute><Layout><PendingPrescription /></Layout></PrivateRoute>} />
                <Route path="/PendingAssignedPrescriptionDetails" element={<PrivateRoute><Layout><PendingAssignedPrescriptionDetails /></Layout></PrivateRoute>} />
                <Route path="/CompletedAssignedPrescription" element={<PrivateRoute><Layout><CompletedAssignedPrescription /></Layout></PrivateRoute>} />
                <Route path="/pendingfull" element={<PrivateRoute><Layout><PendingFullAssigned /></Layout></PrivateRoute>} />
                <Route path="/UserProfile" element={<PrivateRoute><Layout><UserProfile /></Layout></PrivateRoute>} />
                <Route path="/pastpatient" element={<PrivateRoute><Layout><PastPatient /></Layout></PrivateRoute>} />
                <Route path="/create-password" element={<CreatePassword />} />
                {/* <Route path="/startappointment" element={<StartAppointment />} /> */}
                {/* <Route path="/patientprofile" element={<PatientProfile />} /> */}
                {/* <Route path="/patientdetails" element={<PatientDetails />} /> */}
            ...
            <Route path="/terms" element={<Layout><TermsAndConditions /></Layout>} /> */}
                <Route path="/myappointment" element={<PrivateRoute><Layout><MyAppointments /></Layout></PrivateRoute>} />
